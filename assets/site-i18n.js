(() => {
  ...
  const messages = {
    en: {
      ...
      'ForgeKit editor preview': 'ForgeKit editor preview',
      'Scroll to forge': 'Explore the workflow',
      'XCODE HANDOFF': 'CONTINUE IN XCODE',
      'From scene to Xcode': 'From scene to Xcode',
      'Research': 'Research',
      'Architecture research': 'Architecture research',
      'Research paper': 'Research paper',
      'POSITION PAPER': 'POSITION PAPER',
      'Isolated ownership': 'Isolated ownership',
      'Typed async messages': 'Typed async messages',
      'Independent timing': 'Independent timing',
      'Declarative flow': 'Declarative flow',
      'Read the paper on Zenodo': 'Read the paper on Zenodo',
      ...
      'Follow the same Moonwhisk Vale project from guided editing to Play Preview. The scene, inspector, and controls stay connected as you switch views.': 'Follow the same Moonwhisk Vale project from guided editing to Play Preview. The scene, inspector, and controls stay connected as you switch views.',
      ...
      'ForgeKit mascot': 'ForgeKit mascot',
      ...
      'Worldsmith is the ForgeKit mascot.': 'Worldsmith is the ForgeKit mascot.'
    },
  ...
  const templates = {
    en: {
      ...
      'research-title': 'The architecture proposed in the paper, <span class="heading-muted">implemented and tested in ForgeKit.</span>',
